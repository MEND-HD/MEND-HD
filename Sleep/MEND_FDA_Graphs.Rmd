...
This document shows the code used to generate side by side regression plots from awakening count data for sleep. The same code was used to generate WASO graphs.
